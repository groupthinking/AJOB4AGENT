...
echo "   Value: h@haydengarvey.com"
echo "   → Your Gmail email address"
echo ""

echo "3. SMTP_PASSWORD"
echo "   Value: wusv nhcj hjok vqml"
echo "   → Your Gmail app password (generated for h@haydengarvey.com)"
echo ""
...
echo "gh secret set SMTP_USERNAME --body 'h@haydengarvey.com'"
echo "gh secret set SMTP_PASSWORD --body 'wusvnhcjhjokvqml'"
echo "gh secret set SMTP_FROM --body 'h@haydengarvey.com'"
